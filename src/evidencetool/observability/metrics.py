...
class MetricsData:
    ...
    policy_duration: float = 0.0  # Currently combined or zero, but placeholder
...
def write_metrics(metrics: MetricsData, output_path: str = "./evidencetool.prom"):
    ...
    lines.append("# HELP evidencetool_integrity_violation Count of decision integrity violations.")
    ...
    lines.append("# HELP evidencetool_policy_duration_seconds Time spent in the policy engine.")
    lines.append("# TYPE evidencetool_policy_duration_seconds gauge")
    lines.append(f"evidencetool_policy_duration_seconds {metrics.policy_duration:.4f}")
    ...
    lines.append("# HELP evidencetool_decision Counter for decisions.")
    ...
    lines.append("# HELP evidencetool_evidence Counter for individual evidence evaluations.")
